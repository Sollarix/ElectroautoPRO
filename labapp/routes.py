...
def index():
    ...
    subjs = ["CHEAPEST EV", "TOP RANGE EV", "TOP SPEED EV", "TOP EFFICIENCY EV"]
    ...
    return render_template('index.html', title='ElectroautoPRO', pname='HOME', navmenu=controller.navmenu,
                           imgs=imgs, subjs=subjs, processed_files=processed_files)

# Обработка запроса к странице contact.html
@app.route('/contact')
def contact():
    return render_template('contact.html', title='ElectroautoPRO', pname='CONTACT', navmenu=controller.navmenu)
